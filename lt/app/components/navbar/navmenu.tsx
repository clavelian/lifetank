      ...
      <NavigationMenu className="mobile:hidden flex justify-center items-center p-1 pl-14">
        <NavigationMenuList>
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-4 tablet:w-[400px] smscreen:w-[400px] wscreen:w-[400px] ">
          ...
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-3 py-4 px-3 tablet:w-[400px] tablet:grid-cols-1 smscreen:w-[600px] ">
